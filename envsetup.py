...
def downloadPrebuiltOpencv(prefix='.', out_prefix='.', version='3.3.1'):
...
def sync_submodules():
    ...
    phantomjs = {'url': 'https://bitbucket.org/ariya/phantomjs/downloads/phantomjs-%s-macosx.zip' % ('2.1.1'),
    'path':'', 'binPath':'phantomjs-%s-macosx/bin/phantomjs' % ('2.1.1')}
    phantomjs['path'] = download_file(phantomjs['url'])
    unzipFile(phantomjs['path'])
